            ...
            child: Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: "Pesquise uma localização",
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext ctx, int index) {
              return GestureDetector(
                ...
                onTap: () {
                  _mapController.move(LatLng(double.parse(_addresses[index]['lat']), double.parse(_addresses[index]['lng'])), 19);
                  ...
                  setState(() {
                    ...
                    _markers[0] = Marker(
                      width: 80.0,
                      height: 80.0,
                      point: LatLng(double.parse(_addresses[index]['lat']), double.parse(_addresses[index]['lng'])),
                      builder: (ctx) => new Container(
